							...
							<div class="form-group clearfix">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<input id="senha_atual" name="senha_atual" type="password" inputmode="numeric" pattern="[0-9]+" class="required form-control passw" />
									</div>
								</div>
								...
								<div class="row new_password hidden">
									<div class="col-md-6">
										...
										<input id="senha" name="senha" type="password" inputmode="numeric" pattern="[0-9]+" class="required form-control passw" />
									</div>
									...
									<div class="col-md-6">
										...
										<input id="confirma_senha" name="confirma_senha" type="password" inputmode="numeric" pattern="[0-9]+" class="required form-control passw" />
									</div>
								</div>
							</div>
						</section>
