				...
				<div class="panel-body">
					<form class="form-horizontal m-t-20" method="post">
						<div class="form-group">
							<div class="col-xs-12">
								<input id="cpf" class="form-control" name="cpf" type="text" inputmode="numeric" pattern="[0-9]+" placeholder="CPF" required />
							</div>
						</div>

						<div class="form-group">
							<div class="col-xs-12">
								<input id="senha" class="form-control" name="senha" type="password" inputmode="numeric" pattern="[0-9]+" placeholder="Senha" required />
							</div>
						</div>
